      ...
      <div className="relative z-10">
        ...
        <Chapter number="02" name="Curiosity">
          <div className="grid gap-10 lg:grid-cols-2">
            ...
            <div className="self-end text-lg leading-8 text-white/55">
              ...
              <p>
                From software to systems where failure isn&apos;t an option.
              </p>
            </div>
        ...
        >
          <div className="mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-end">
            ...
            <p className="max-w-sm text-sm leading-6 text-white/45">
              Every project should explain the problem, architecture,
              implementation, result and lesson—not just list technologies.
            </p>
        ...
        >
          <div className="grid gap-12 lg:grid-cols-[.8fr_1.2fr]">
            ...
            <div className="rounded-3xl border border-white/10 bg-black/25 p-7 backdrop-blur-sm md:p-10">
              <div className="space-y-5">
                ...
                {[
                  ...
                  >
                    <span className="mono w-6 text-xs text-white/25">
                      0{i + 1}
                    </span>
        ...
        >
          <div className="grid gap-12 lg:grid-cols-[1fr_.9fr]">
            ...
            <div>
              ...
              <h2 className="display text-5xl font-semibold md:text-8xl">
                WHEN SOFTWARE HAS TO BE RIGHT.
              </h2>
            </div>
            ...
            <div className="self-end">
              ...
              <p className="text-lg leading-8 text-white/55">
                Software verification and embedded systems work changed the
                emphasis from simply building things to building with
                discipline, traceability and confidence.
              </p>
          ...
          <div className="mt-16 grid gap-px overflow-hidden rounded-3xl border border-white/10 bg-white/10 md:grid-cols-5">
            ...
            {[
              ...
              >
                <div className="mono text-[10px] text-white/25">
                  0{i + 1}
                </div>
        ...
        >
          ...
          <div className="mt-8 rounded-3xl border border-white/10 bg-black/20 p-7 backdrop-blur-sm md:p-9">
        ...
        >
          <div className="flex min-h-[60vh] flex-col justify-center">
            ...
            <p className="mt-8 max-w-xl text-lg leading-8 text-white/50">
              Software. AI. Data. Systems. Research.
              Let&apos;s create something worth engineering.
            </p>
